...
public class Dht : ClientSubCommand {
    ...
    public func findProvs(_ hash: Multihash, completionHandler: (JsonType) -> Void) throws {
    ...
    public func query(_ hash: Multihash, completionHandler: (JsonType) -> Void) throws {
    ...
    public func findpeer(_ hash: Multihash, completionHandler: (JsonType) -> Void) throws {
    ...
    public func get(_ hash: Multihash, completionHandler: (JsonType) -> Void) throws {
    ...
    public func put(_ key: String, value: String, completionHandler: (JsonType) -> Void) throws {
